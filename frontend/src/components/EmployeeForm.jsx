  ...
  return (
    <form className='space-y-6 max-w-3xl animate-fade-in' onSubmit={handleSubmit}>
      ...
      <div className='card p-5 sm:p-6'>
        <h3 className='font-medium mb-6 pb-6 border-b border-slate-100 text-slate-950 '>Personal Information</h3>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm text-slate-700'>
          ...
          <div className='sm:col-span-2'>
            ...
            <textarea name='bio' defaultValue={initialData?.bio} placeholder='Brief description...' rows={3} className='resize-none' />
          </div>
      ...
      <div className='card p-5 sm:p-6'>
        <h3 className='font-medium mb-6 pb-6 border-b border-slate-100 text-slate-950 '>Employment Details</h3>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm text-slate-700'>
          ...
          <div>
            ...
            <input name="basicSalary" type='number'min="0" step="0.01"  defaultValue={initialData?.basicSalary || 0} />
          </div>
          <div>
          ...
          {isEditMode && (
            <div>
              ...
              <select name="employeeStatus" defaultValue={initialData?.employeeStatus} >
      ...
      <div className='card p-5 sm:p-6'>
        <h3 className='font-medium mb-6 pb-6 border-b border-slate-100 text-slate-950 '>Account Setup</h3>

        <div className='grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm text-slate-700'>
          <div className='sm:col-span-2'>
            <label className='block mb-2'>Email</label>
            <input name="email" required defaultValue={initialData?.email} />
          </div>
          {!isEditMode && (
            <div>
