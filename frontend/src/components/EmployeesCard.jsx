...
const EmployeesCard = ({employee, onDelete, onEdit}) => {
  ...
  return (
    <div className='group relative card card-hover overflow-hidden'>
      ...
      {!employee.isDeleted && (
        <div className='absolute inset-0 bg-linear-to-br from-indigo-700/20 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end justify-center pb-6 gap-3'>
