...
const Sidebar = () => {
  ...
  const sidebarContent = (
    <>
       ...
       <div className='px-5 pt-6 pb-5 border-b border-white/6'>
          <div className='flex items-center justify-between'>
            <div className='flex items-center gap-3'>
              ...
              <div>
                 <p className='font-semibold text-[13px] text-white tracking-wide mb-2'>Employee MS</p>
       ...
       <div className='pt-5 px-5 pb-2'>
         <p className='text-medium text-[10px] text-slate-400 font-semibold uppercase tracking-[0.12em]'>Navigation</p>
       </div>
       ...
       <div className='p-3 border-t border-white/6'>
         <button onClick={handleLogout} className='flex gap-3 items-center text-red-600 px-3 py-2.5 rounded-md text-[13px] font-medium text-slate-400 hover:text-rose-400 hover:bg-rose-500/8 transition-all duration-150'>
  ...
  return (
    <>
       ...
       {
        mobileOpen && <div className='lg:hidden inset-0 bg-black/60 backdrop-blur-sm z-40' onClick={()=>setMobileOpen(false)}/>
       }

       {/* Sidebar - desktop */}
       <aside className='hidden lg:flex flex-col h-full w-[-260px] bg-linear-to-b from-slate-900 via-slate-950 text-white shrink-0 border-r border-white/4'>
          {sidebarContent}
       </aside>
